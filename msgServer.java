 ...
 *					The backlog of this server has been set to 5. Any clients that
 *					try to connect to server when queue is full (when there are 5 clients 
 *                  already waiting in the queue) will be rejected.
 ...
 * TO COMPILE:		javac msgServer.java
 * TO RUN:			java msgServer
 *
 */
